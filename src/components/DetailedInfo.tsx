...
export function DetailedInfo() {
  return (
    <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Up to 330 miles of estimated range
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
      ...
      <div className="space-y-6">
        <h3 className="text-3xl font-bold text-white">Giveaway Details</h3>
        <div className="prose prose-invert">
          <p className="text-gray-300">
            Enter for your chance to win this custom Tesla Model Y, featuring
            premium upgrades and modifications. The winner will receive:
          </p>
          <ul className="text-gray-300 list-disc pl-4 space-y-2">
            <li>2023 Tesla Model Y Long Range</li>
          ...
          <p className="text-gray-300 mt-4">
            Don't miss out on this incredible opportunity to own one of the most
            sought-after electric vehicles on the market, customized to
            perfection.
          </p>
        </div>
      </div>
